...
UPDATE:
All magnetic variables now have been decomposed in to a background and time-evolving components, 
where the background means A_b such that curl of A_b = (B_0 costheta, B_0 sintheta, 0). This was needed 
